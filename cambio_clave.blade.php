...
<div class="w-[50%] h-[800%] m-auto mt-[8%]">
    <form action="#" method="post" class="w-[100%] h-[100%]">
        <div>
            ...
            <input type="password" name="claveIngreso" id="claveIngreso" class="w-[100%] rounded-md mt-2 text-[#666] ring-1 ring-inset ring-gray-100 border-gray-300 placeholder:text-gray-400 outline-none">
            
        </div>
        <div class="mt-5">
            <label for="claveConfirmacion" class="font-medium leading-6 text-gray-900"> Confirma contraseña </label>
            <input type="password" name="claveConfirmacion" id="claveConfirmacion" class="w-[100%] rounded-md mt-2 text-[#666] ring-1 ring-inset ring-gray-100 border-gray-300 placeholder:text-gray-400 outline-none">
