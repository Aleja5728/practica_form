...
<!-- Vista CRUD -->
<div class="absolute flex w-full h-12 mt-10">
    <div class="ml-8 mr-8">
        <p class="font-montserrat text-3xl font-normal"> Lista de usuarios </p>
    </div>
    <div>
        <button class="bg-[#3268C9] text-[#fff] font-montserrat text-xs rounded-xl w-32 h-9 p-2 cursor-pointer boton_modal1">
            Agregar usuario
        </button>
    </div>
    <div class="absolute right-12 barra_busqueda">
        <div>
            <div>
                <input type="text" name="buscar_usuario" id="buscar_usuario"  autocomplete="off" class="pb-0 mt-2 bg-transparent border-[#3268C9] border-y-0 border-x-0 border-b-[1.5px] w-96 focus:ring-0 relative right-7">
            </div>
        </div>
    </div>
    <div class="absolute right-12">
        <div>
            <button class="w-10 h-10 cursor-pointer absolute top-1 right-7">
                <img src=" {{ asset('img/icons8-búsqueda-24.png') }}" alt="Icono de busqueda" class="icono_busqueda">
            </button>
        </div>
    </div>
                ...
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    <div class="sm:col-span-3">
                        <label for="nombre" class="block text-sm font-medium leading-6 text-gray-900">Nombres
                            completos</label>
                        <div class="mt-2">
                            <input type="text" name="nombre" id="nombre" autocomplete="given-name" class="block w-full rounded-md border-0 p-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 outline-none">
                        </div>
                    </div>
                    ...
                    <div class="sm:col-span-3">
                        <label for="apellido" class="block text-sm font-medium leading-6 text-gray-900">Apellidos
                            completos</label>
                        <div class="mt-2">
                            <input type="text" name="apellido" id="apellido" autocomplete="family-name" class="block w-full rounded-md border-0 p-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 outline-none">
                        </div>
                    </div>
                    ...
                    <div class="sm:col-span-3">
                        <label for="numero_documento" class="block text-sm font-medium leading-6 text-gray-900">Número
                            ...
                            documento</label>
                        <div class="mt-2">
                            <input type="number" name="numero_documento" id="numero_documento" class="block w-full rounded-md border-0 p-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus-ring-inset focus-ring-indigo-600 sm-text-sm sm-leading-6 outline-none">
                        </div>
                    </div>
                    ...
                    <div class="sm:col-span-3">
                        ...
                        <div class="mt-2">
                            <select name="genero" id="genero" class="block w-full rounded-md border-0 p-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus-ring-inset focus-ring-indigo-600 sm-text-sm sm-leading-6 outline-none">
                    ...
                    <div class="sm:col-span-3">
                        <label for="telefono" class="block text-sm font-medium leading-6 text-gray-900">Número
                            telefonico</label>
                        <div class="mt-2">
                            <input type="number" name="telefono" id="telefono" class="block w-full rounded-md border-0 p-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus-ring-inset focus-ring-indigo-600 sm-text-sm sm-leading-6 outline-none">
                        </div>
                    </div>
                    ...
                    <div class="sm:col-span-3">
                        <label for="correo" class="block text-sm font-medium leading-6 text-gray-900">Correo
                            electrónico</label>
                        <div class="mt-2">
                            <input type="email" name="correo" id="correo" class="block w-full rounded-md border-0 p-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus-ring-inset focus-ring-indigo-600 sm-text-sm sm-leading-6 outline-none">
                        </div>
                    </div>
                    ...
                    <div class="sm:col-span-3">
                        ...
                        <div class="mt-2">
                            <select name="dependencia" id="dependencia" class="block w-full rounded-md border-0 p-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus-ring-inset focus-ring-indigo-600 sm-text-sm sm-leading-6 outline-none">
                    ...
                    <div class="sm:col-span-3 mt-8 block">
                        ...
                        <input type="radio" name="tipo_funcionario" id="contratista" value="contratista" class="">
                    ...
                    <div class="sm:col-span-3">
                        ...
                        <div class="mt-2">
                            <select name="cargo" id="cargo" class="block w-full rounded-md border-0 p-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus-ring-inset focus-ring-indigo-600 sm-text-sm sm-leading-6 outline-none">
                                <option value="defecto">SELECCIONE UNA OPCION</option>
